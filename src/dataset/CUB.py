...
class CUBDataset(Dataset):
    def __init__(self,
        ...
        self.marg_c = [np.mean(self.concepts[c]) for c in range(len(self.concepts))]
...
class CUBDataModule:
    def __init__(self, use_weighted_sampler=False,
                  embed_image=True, merge_train_val=False, n_decoys=0, n_removed=0):
